...
int main(int argc, char **argv) {
    ...
    writePdfCdf(
        folder + "/queue_packets_drops_nonecn_pdf",
        folder + "/queue_packets_drops_nonecn_cdf",
        folder + "/queue_delay_nonecn_ccdf",
        header,
        values_qd_classic,
        values_d_classic
    );
    ...
    writePdfCdf(
        folder + "/queue_packets_drops_ecn_pdf",
        folder + "/queue_packets_drops_ecn_cdf",
        folder + "/queue_delay_ecn_ccdf",
        header,
        values_qd_l4s,
        values_d_l4s
    );
